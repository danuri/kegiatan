                    ...
                    <tbody>
                      <?php foreach ($peserta as $row) {?>
                        <tr>
                          ...
                          <td> <a href="<?= site_url('pengelola/kegiatan/peserta/'.encrypt($row->id))?>" class="btn btn-sm btn-primary">Detail</a> <a href="<?= site_url('pengelola/kegiatan/topdf/'.encrypt($row->id))?>" class="btn btn-sm btn-warning">PDF</a> <a href="<?= site_url('pengelola/kegiatan/delete/peserta/'.encrypt($row->id))?>" onclick="return confirm('Peserta akan dihapus?')" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>
                      <?php } ?>
                    </tbody>
                  </table>
